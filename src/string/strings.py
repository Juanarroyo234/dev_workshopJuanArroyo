class Strings:
    ...
    def cifrar_cesar(self, texto, desplazamiento):
        ...
        for caracter in texto:
            if caracter.isalpha():
                ...
                nuevo_caracter = inicio + (ord(caracter) - inicio + desplazamiento) % 26
                resultado += chr(nuevo_caracter)
            else:
                resultado += caracter  # Mantiene los espacios y signos de puntuación
        return resultado
    ...
    def descifrar_cesar(self, texto, desplazamiento):
        ...
        """
        texto_descifrado = ""
        desplazamiento_real = desplazamiento % 26  # Asegura que el desplazamiento esté dentro del rango
        ...
        for caracter in texto:
            if caracter.isalpha():
                ...
                texto_descifrado += caracter  # Asegura que no se omitan espacios y signos de puntuación
